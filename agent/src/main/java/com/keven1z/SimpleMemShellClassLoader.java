 ...
 */
public class SimpleMemShellClassLoader extends URLClassLoader {

    private final String toString;

    SimpleMemShellClassLoader(
            final String engineJarFilePath) throws MalformedURLException {
        super(new URL[]{new URL("file:" + engineJarFilePath)});
        this.toString = String.format("SimpleMemShell[path=%s;]", engineJarFilePath);
    }
